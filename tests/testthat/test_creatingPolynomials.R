...
test_that("makePoly", {
  ...
  res1 <- makePoly(vars, maxExponent = 1, inverseExponent = 1)
  res2 <- makePoly(vars, maxExponent = 2, inverseExponent = 1)
  expect_equal(res1, vars)
  expect_equal(makePoly(vars, maxExponent = 3, inverseExponent = 1),
               c(makePoly(vars, maxExponent = 2, inverseExponent = 1),
